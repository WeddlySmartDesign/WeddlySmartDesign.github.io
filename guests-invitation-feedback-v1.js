...
function patch(){
  try{
    ...
    if(!d.documentElement.dataset.wsdInvitationFeedback){d.documentElement.dataset.wsdInvitationFeedback='2';const s=d.createElement('script');s.src='guests-invitation-editor-feedback-inner-v1.js?v=2';d.head.appendChild(s)}
  }catch{}
}
